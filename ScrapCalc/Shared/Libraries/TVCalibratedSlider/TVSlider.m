...
-(void)valueChanged {
    ...
    NSInteger roundValue = roundf(self.value);
    if(previousValue_ != roundValue)
    {
        previousValue_ = roundValue;
        [[self delegate] didChangeToAnotherValue:previousValue_];
    }
