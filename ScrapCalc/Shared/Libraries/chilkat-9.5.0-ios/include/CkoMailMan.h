...
// property getter: P7mEncryptAttachFilename
- (NSString *)P7mEncryptAttachFilename;

// property setter: P7mEncryptAttachFilename
- (void)setP7mEncryptAttachFilename: (NSString *)input;

// property getter: P7mSigAttachFilename
- (NSString *)P7mSigAttachFilename;

// property setter: P7mSigAttachFilename
- (void)setP7mSigAttachFilename: (NSString *)input;

// property getter: P7sSigAttachFilename
- (NSString *)P7sSigAttachFilename;

// property setter: P7sSigAttachFilename
- (void)setP7sSigAttachFilename: (NSString *)input;
